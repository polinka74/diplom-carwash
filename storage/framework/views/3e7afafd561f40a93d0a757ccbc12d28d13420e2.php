                ...
                <div class="card-body">
                  ...
                  <div class="form-group">
                   ...
                   <div class="form-group">
                    ...
                    <input type="text" name="descript" value="<?php echo e($goods['descript']); ?>" class="form-control" id="exampleInputPassword1" placeholder="Введите сокращенное описание" required>
                  </div>
                    <div class="form-group">
                    <label for="exampleInputPassword1">description</label>
                    <input type="text" name="description" value="<?php echo e($goods['description']); ?>" class="form-control" id="exampleInputPassword1" placeholder="Введите полное описание" required>
                  </div>
                    <div class="form-group">
                    <label for="exampleInputPassword1">characteristics</label>
                    <input type="text" name="characteristics" value="<?php echo e($goods['characteristics']); ?>" class="form-control" id="exampleInputPassword1" placeholder="Введите характеристики" required>
                  </div>
                </div>
                <!-- /.card-body -->
...
<?php echo $__env->make('layouts.admin_layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/p/polinawz/polinawz.beget.tech/public_html/resources/views/admin/goods/edit.blade.php ENDPATH**/ ?>