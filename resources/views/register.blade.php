        ...
        <div class="col-md-10">
            <form method="POST" action="{{ route('register') }}">
                ...
                <div class="row mb-3">
                    ...
                    <div class="col-md-6">
                        <input id="name" type="text" class="form-control" name="name" value="{{ old('name') }}" required autocomplete="name" autofocus pattern="^[А-Яа-яЁё\s\-]+$" title="Разрешенные символы: кириллица, пробел и тире">
                    </div>
                </div>
               ...
               <!--  <div class="row mb-3">
                   ...
                   <div class="col-md-6">
                       <input id="login" type="text" class="form-control" name="login" value="{{ old('login') }}" required autocomplete="login" autofocus pattern="^[A-Za-z0-9\-]+" title="Разрешенные символы: латиница и тире">
                   </div>
               </div> -->
                <!-- Почта -->
                <div class="row mb-3">
