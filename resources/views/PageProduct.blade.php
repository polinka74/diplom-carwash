...
<div class="card mb-3" style=" margin:0 auto; max-width:1200px;">
    <section class="py-3 border-bottom border-top d-none d-md-flex bg-light">
        <div class="container">
            <div class="page-breadcrumb d-flex align-items-center">
                <h3 class="breadcrumb-title pe-3">{{$ProductRow['title']}}</h3>
                <div class="ms-auto">
                    <nav style="--bs-breadcrumb-divider: '>';" aria-label="breadcrumb">
                        <ol class="breadcrumb">
                            <li class="breadcrumb-item"><a href="/price">Прайс</a></li>
                            <li class="breadcrumb-item active" aria-current="page">{{$ProductRow['title']}}</li>
                        </ol>
                    </nav>
                </div>
            </div>
    ...
    <div class="row g-0">
        <div class="col-md-4">
            <img src="{{$ProductRow->image}}" class="img-fluid  p-4 m-4" alt="...">
        </div>
        <div class="col-md-7 m-4 ">
            <div class="card-body">
                <h5 class="card-title mt-4">{{$ProductRow->title}}</h5><hr>
                <div class="product-aside__newprice-retail text">{{$ProductRow->price}}
                    <span>Ваша цена</span>
                </div><br>
                <h4 class="card-text">О товаре:
                </h4>
                <p>{{$ProductRow->descript}}</p>
                <hr>
            </div>
        </div>
    </div>
						...
						<div class="product-more-info ">
							...
							<div class="tab-content pt-3">
								...
								<div class="tab-pane fade" id="more-info" role="tabpanel">
									<p>{{$ProductRow->characteristics}}</p>
								</div>
							</div>
						</div>
					</div>
